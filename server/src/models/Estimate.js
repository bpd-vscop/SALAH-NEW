...
const estimateAddressSchema = new mongoose.Schema(
  {
    companyName: {
      type: String,
      trim: true,
...
const estimateSchema = new mongoose.Schema(
  {
    ...
    items: {
      ...
      validate: [(items) => items.length > 0, 'Estimate must contain items'],
    },
    status: {
      type: String,
...
estimateSchema.pre('save', function updateTimestamp(next) {
