...
const { getCategoryDisplay, updateCategoryDisplay, uploadCategoryDisplayHeroImage } = require('../controllers/categoryDisplayController');
...
router.post(
  ...
  handleMarketingImageUpload(uploadCategoryDisplayHeroImage, 'Category display hero image')
);
